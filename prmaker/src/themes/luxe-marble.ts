...
export const luxeMarble: ThemeConfig = {
  id: "luxe-marble",
  name: "Luxe Marble",
  nameKo: "럭스 마블",
  description: "Marble texture luxury for premium shopping hosts",
  descriptionKo: "대리석 질감 럭셔리 쇼호스트형",
  recommendedFor: "프리미엄 쇼호스트, 명품/뷰티 전문",

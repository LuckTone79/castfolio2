...
export const prestigeBlack: ThemeConfig = {
  id: "prestige-black",
  name: "Prestige Black",
  nameKo: "프레스티지 블랙",
  description: "Luxurious and charismatic, for premium presenters",
  descriptionKo: "고급스럽고 카리스마 있는 시사/프리미엄형",
  recommendedFor: "시사 MC, 고급 진행자",

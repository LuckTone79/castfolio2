...
export const naturalGreen: ThemeConfig = {
  id: "natural-green",
  name: "Natural Green",
  nameKo: "내추럴 그린",
  description: "Natural and calming, for lifestyle and wellness",
  descriptionKo: "자연스럽고 편안한 힐링/웰니스형",
  recommendedFor: "라이프스타일, 힐링 방송, 건강",

...
export const softBlush: ThemeConfig = {
  id: "soft-blush",
  name: "Soft Blush",
  nameKo: "소프트 블러시",
  description: "Soft and friendly, for beauty and lifestyle hosts",
  descriptionKo: "부드럽고 친근한 뷰티/라이프스타일형",
  recommendedFor: "뷰티 쇼호스트, 라이프스타일, 홈쇼핑",

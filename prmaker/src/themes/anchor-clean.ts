...
export const anchorClean: ThemeConfig = {
  id: "anchor-clean",
  name: "Anchor Clean",
  nameKo: "앵커 클린",
  description: "Clean and trustworthy, ideal for news anchors",
  descriptionKo: "깨끗하고 신뢰감 있는 뉴스 아나운서형",
  recommendedFor: "뉴스 아나운서, 정통파 진행자",

...
export const freshSky: ThemeConfig = {
  id: "fresh-sky",
  name: "Fresh Sky",
  nameKo: "프레시 스카이",
  description: "Cool and active, for sports casters and travel reporters",
  descriptionKo: "시원하고 활동적인 리포터형",
  recommendedFor: "스포츠 캐스터, 여행 리포터",

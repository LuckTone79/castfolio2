...
export const LAYOUTS: LayoutConfig[] = [
  ...
  {
    id: 'stitch-editorial-01',
    name: 'Velvet Signature',
    fonts: {
      display: "'Noto Serif', serif",
      body: "'Work Sans', sans-serif"
    }
  ...
  {
    id: 'stitch-scrapbook-04',
    name: 'Paper Tape Muse',
    fonts: {
